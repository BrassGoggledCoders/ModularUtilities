...
public class EnchantmentAffluency extends CustomEnchantment {
	...
	public EnchantmentAffluency(Rarity rarity, EnumEnchantmentType type, EntityEquipmentSlot[] slots, int multiplier,
	...
	public boolean canApplyAtEnchantingTable(ItemStack stack) {
		return stack.getItem() instanceof ItemSword
				|| Optional.ofNullable(type).map(value -> value.canEnchantItem(stack.getItem())).orElse(false);
	}
